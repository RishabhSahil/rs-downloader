...
def download(link):
    try:
        if (link):
            ...
            google_reel.download(fp=f".\\Rishabh{int(time.time())}.mp4")
...
background_image = ImageTk.PhotoImage(Image.open(r"F:\My_Projects_Rishabh_Search_Engine\YouTube-Downloader\static\insta_login.png"))
